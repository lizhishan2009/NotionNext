...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Betterme', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱学习的王同学', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://betterme.group', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Betterme, 博客', // 网站关键词 英文逗号隔开
